class User {
  ...
  async getUserDetailById (userid, lang) {
    return await this._request('/user/get', {userid, lang})
  }
  /**
   * 获取部门成员
  ...
  async getUserListByDepartment (department_id, offset, size, order, lang) {
    return await this._request('/user/simplelist', {department_id, offset, size, order, lang})
  }
  /**
   * 获取部门成员详情
  ...
  async getUserDetailByDepartment (department_id, offset, size, order, lang) {
    return await this._request('/user/list', {department_id, offset, size, order, lang})
  }
  /**
   ...
   */
  async getAdminList () {
    return await this._request('/user/get_admin')
  }
  /**
   * 根据
  ...
  async getUseridByUnionid (unionid) {
    return await this._request('/user/getUseridByUnionid', {unionid})
  }
  /**
   * 获取部门的所有成员
  ...
  async getAllUserList () {
    return await this._getAllUserInfoList('getUserListByDepartment')
  }
  /**
   * 获取所有成员详情
   */
  async getAllUserDetailList () {
    return await this._getAllUserInfoList('getUserDetailByDepartment')
  }
  /**
   * 获取所有部门成员信息
